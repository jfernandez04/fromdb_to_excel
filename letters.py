# coding=utf-8
# this are the letters used for excel columns
letters = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v',
           ...
           'cr', 'cs', 'ct', 'cu', 'cv', 'cw', 'cx', 'cy', 'cz', 'da', 'db', 'dd', 'dd', 'de', 'df', 'dg', 'dh', 'di',
           'dj', 'dk', 'dl', 'dm', 'dn', 'do', 'dp', 'dq',
           'dr', 'ds', 'dt', 'du', 'dv', 'dw', 'dx', 'dy', 'dz', 'ea', 'eb', 'ee', 'ee', 'ee', 'ef', 'eg', 'eh', 'ei',
           'ej', 'ek', 'el', 'em', 'en', 'eo', 'ep', 'eq',
           'er', 'es', 'et', 'eu', 'ev', 'ew', 'ex', 'ey', 'ez', 'fa', 'fb', 'ff', 'ff', 'fe', 'ff', 'fg', 'fh', 'fi',
           'fj', 'fk', 'fl', 'fm', 'fn', 'fo', 'fp', 'fq',
           'fr', 'fs', 'ft', 'fu', 'fv', 'fw', 'fx', 'fy', 'fz', 'ga', 'gb', 'gg', 'gg', 'ge', 'gf', 'gg', 'gh', 'gi',
           'gj', 'gk', 'gl', 'gm', 'gn', 'go', 'gp', 'gq',
           'gr', 'gs', 'gt', 'gu', 'gv', 'gw', 'gx', 'gy', 'gz', 'ha', 'hb', 'hh', 'hh', 'he', 'hf', 'hg', 'hh', 'hi',
